...
-- Sibling checkouts (same layout as LemmaScript case studies):
--   ../velvet   (namin/velvet @ lemma)
--   ../loom     (namin/loom @ lemma, pulled via Velvet)
--   ../LemmaScript (midspiral/LemmaScript)
require Velvet from ".." / "velvet"
require LemmaScript from ".." / "LemmaScript"

package SocialCalcLemma where
