...
// test and don't fire against stale module state later in the same isolated
// Vitest worker. The idempotent installer also prevents nested wrappers when
// setup is repeated within a file.
