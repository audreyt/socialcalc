declare namespace SocialCalc {
  ...
  interface SocialCalcConstants {
    ...
    s_fdef_FILTER: string;
    s_fdef_SEQUENCE: string;
    s_fdef_TRANSPOSE: string;
    s_fdef_SORTBY: string;
    s_fdef_CHOOSECOLS: string;
    s_fdef_CHOOSEROWS: string;
    s_fdef_TAKE: string;
    s_fdef_DROP: string;
    s_fdef_HSTACK: string;
    s_fdef_VSTACK: string;
    s_fdef_TOCOL: string;
    s_fdef_TOROW: string;
    s_fdef_WRAPROWS: string;
    s_fdef_WRAPCOLS: string;
    s_fdef_EXPAND: string;
    s_farg_filter: string;
    s_farg_sequence: string;
    s_farg_sortby: string;
    s_farg_choosecols: string;
    s_farg_chooserows: string;
    s_farg_take: string;
    s_farg_drop: string;
    s_farg_hstack: string;
    s_farg_vstack: string;
    s_farg_tocol: string;
    s_farg_torow: string;
