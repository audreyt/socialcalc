...
(SocialCalc as unknown as { LocalizeStringList: { [key: string]: unknown } }).LocalizeStringList =
...
SocialCalc.SpreadsheetViewer =
  SpreadsheetViewerCtor as unknown as SocialCalc.SpreadsheetViewerConstructor;

// Methods:

SocialCalc.SpreadsheetViewer.prototype.InitializeSpreadsheetViewer = function (
  this: SocialCalc.SpreadsheetViewer,
...
SocialCalc.SpreadsheetViewer.prototype.LoadSave = function (
  this: SocialCalc.SpreadsheetViewer,
  str: string,
) {
  return SocialCalc.SpreadsheetViewerLoadSave(this, str);
};
SocialCalc.SpreadsheetViewer.prototype.DoOnResize = function (this: SocialCalc.SpreadsheetViewer) {
  return SocialCalc.DoOnResize(this);
};
SocialCalc.SpreadsheetViewer.prototype.SizeSSDiv = function (this: SocialCalc.SpreadsheetViewer) {
  return SocialCalc.SizeSSDiv(this);
};
SocialCalc.SpreadsheetViewer.prototype.DecodeSpreadsheetSave = function (
  this: SocialCalc.SpreadsheetViewer,
  str: string,
) {
  return SocialCalc.SpreadsheetViewerDecodeSpreadsheetSave(this, str);
};
SocialCalc.SpreadsheetViewer.prototype.ParseSheetSave = function (
  this: SocialCalc.SpreadsheetViewer,
  str: string,
) {
...
SocialCalc.SpreadsheetViewerLoadSave = function (
  ...
  if (parts) {
    ...
    if (parts.repeatingmacro) {
      // first line tells how many seconds before first execution. Last cmd must be "cmdextension repeatmacro delay" to continue repeating.
 ...
 * @param {any} saveundo
 */
SocialCalc.SpreadsheetViewerRepeatMacroCommand = function (
  name: string,
  data: unknown,
  sheet: SocialCalc.Sheet,
  cmd: SocialCalc.Parse,
  _saveundo: boolean,
): void {
  var spreadsheet = SocialCalc.GetSpreadsheetViewerObject();
...
SocialCalc.LocalizeString = function (str: string): string {
  ...
  if (!cstr) {
    // no - look up
    cstr =
      SocialCalc.Constants["s_loc_" + str.toLowerCase().replace(/\s/g, "_").replace(/\W/g, "X")] ||
      str;
...
/** @param {any} spreadsheet */
SocialCalc.SpreadsheetViewerCreateSheetHTML = function (
  spreadsheet: SocialCalc.SpreadsheetViewer,
): string {
  var context, div, ele;
