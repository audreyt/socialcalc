declare namespace SocialCalc {
  namespace Popup {
    ...
    interface PopupAttribs {
      ...
      changedcallback?: (
        attribs: PopupAttribs & { panelobj?: any },
        id: string,
        newvalue: any,
      ) => void;
      sampleWidth?: string;
    ...
    const Types: Record<string, PopupTypeHandler> & {
      ...
      ColorChooser: PopupTypeHandler & {
        ...
        gridToG(grid: { table?: HTMLElement; [k: string]: unknown }, row: number, col: number): any;
    ...
    function Create(
      type: "List" | "ColorChooser" | (string & {}),
      id: string,
      attribs?: PopupAttribs,
    ): void;
