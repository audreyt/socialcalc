declare namespace SocialCalc {
   ...
   function SpreadsheetViewerRepeatMacroCommand(name: string, data: unknown, sheet: Sheet, cmd: Parse, saveundo: boolean): void;
   function SpreadsheetViewerStopRepeatingMacro(): void;
   function SpreadsheetViewerDoButtonCmd(e: Event, buttoninfo: unknown, bobj: { element: HTMLElement; functionobj: { command: string; [k: string]: unknown }; [k: string]: unknown }): void;
   ...
   function SpreadsheetViewerStatuslineCallback(editor: TableEditor, status: string, arg: unknown, params: { spreadsheetobj?: SpreadsheetViewer; [k: string]: unknown }): void;
