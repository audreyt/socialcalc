declare namespace SocialCalc {
  ...
  type DragFunctionHandler = (
    event: Event,
    draginfo: typeof DragInfo,
    dobj: DragRegisteredElement,
  ) => void;
  ...
  interface ButtonFunctionObject {
    MouseDown?: (
      e: MouseEvent,
      buttoninfo: typeof ButtonInfo,
      bobj: ButtonRegisteredElement,
    ) => void;
  ...
  interface MouseWheelFunctionObject {
    WheelMove?: (
      event: Event,
      delta: number,
      mousewheelinfo: typeof MouseWheelInfo,
      wobj: MouseWheelRegisteredElement,
    ) => void;
    [key: string]: any;
  }
  ...
  function ProcessEditorColsizeMouseDown(
    e: MouseEvent,
    ele: HTMLElement,
    result: GridMousePositionResult,
  ): void;
  ...
  function ProcessEditorRowselectMouseDown(
    e: MouseEvent,
    ele: HTMLElement,
    result: GridMousePositionResult,
  ): void;
  ...
  function ProcessEditorColselectMouseDown(
    e: MouseEvent,
    ele: HTMLElement,
    result: GridMousePositionResult,
  ): void;
  ...
  function ProcessEditorRowsizeMouseDown(
    e: MouseEvent,
    ele: HTMLElement,
    result: GridMousePositionResult,
  ): void;
  ...
  function SetDragAutoRepeat(
    editor: TableEditor,
    mouseinfo: { [key: string]: any } | null,
    callback?: ((coord: string, direction: string) => void) | null,
  ): void;
  ...
  function EditedTriggerCell(
    actionFormulaCells: { [key: string]: any },
    editedCellRef: string,
    editor: TableEditor,
    sheet: Sheet,
  ): void;
  ...
  function EditorProcessMouseWheel(
    event: Event,
    delta: number,
    mousewheelinfo: MouseWheelRegisteredElement,
    wobj: MouseWheelRegisteredElement,
  ): void;
  ...
  function GridMousePosition(
    ...
    clientX: number,
    clientY: number,
  ): GridMousePositionResult;
  function GetEditorCellElement(
    editor: TableEditor,
    row: number,
    col: number,
  ): RenderedCellRef | null;
  ...
  function SegmentDivHit(
    segtable: Array<number | string | any[]>,
    divWithMouseHit: HTMLElement,
    x: number,
    y: number,
  ): number;
  ...
  function DragRegister(
    ...
    vertical: boolean,
    horizontal: boolean,
    functionobj: DragFunctionObject | null,
    parent: HTMLElement,
  ): void;
  ...
  function ButtonRegister(
    editor: TableEditor,
    element: HTMLElement,
    paramobj: ButtonParamObject | null,
    functionobj: ButtonFunctionObject | null,
  ): void;
