...
FormulaParseMut.ParseFormulaIntoTokens = function (line: string): SocialCalc.FormulaParseToken[] {
  ...
  for (i = 0; i <= line.length; i++) {
    ...
    if (state == parsestate.string) {
      ...
      // special values like #REF!, #NAME?, #N/A
...
FormulaParseMut.ArrayValuesEqual = function (a: unknown[], b: unknown[]): boolean {
  var i = a.length;
