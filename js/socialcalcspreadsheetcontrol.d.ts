...
declare namespace SocialCalc {
  ...
  interface SpreadsheetControl {
    ...
    formulabuttons: {
      [key: string]: {
        ...
        skipImagePrefix?: boolean;
      };
    };
    findbuttons: {
      [key: string]: { image: string; tooltip: string; command: (...args: any[]) => any };
    };
  ...
  interface SpreadsheetControlConstructor {
    ...
    FillFunctionNames(cname: string, ele: HTMLSelectElement): void;
    GetFunctionInfoStr(fname: string): string;
    FunctionClassChosen(cname: string): void;
    FunctionChosen(fname: string): void;
    HideFunctions(): void;
    DoFunctionPaste(): void;
    DoMultiline(): void;
    HideMultiline(): void;
    DoMultilineClear(): void;
    DoMultilinePaste(): void;
    DoLink(): void;
    HideLink(): void;
    DoLinkClear(): void;
    DoLinkPaste(): void;
    DoSum(): void;
    FindInSheet(): void;
    SearchSheet(direction: 0 | 1): void;
    SearchUp(): void;
    SearchDown(): void;
  }
  ...
  function InitializeSpreadsheetControl(
  ...
  function DoButtonCmd(
    ...
    bobj: {
      element: HTMLElement;
      functionobj: { command: string; [k: string]: any };
      [k: string]: any;
    },
  ): void;
  function DoCmd(obj: HTMLElement | null, which: string): void;
  function SpreadsheetControlExecuteCommand(
    obj: HTMLElement | null,
    combostr: string,
    sstr: string,
  ): void;
  function SpreadsheetControlCreateSheetHTML(spreadsheet: SpreadsheetControl): string;
  function SpreadsheetControlCreateCellHTML(
    spreadsheet: SpreadsheetControl,
    coord: string,
    linkstyle?: any,
  ): string;
  function SpreadsheetControlCreateCellHTMLSave(
    spreadsheet: SpreadsheetControl,
    range?: string,
    linkstyle?: any,
  ): string;
  ...
  function SpreadsheetControlCreateSpreadsheetSave(
    spreadsheet: SpreadsheetControl,
    otherparts?: { [key: string]: string },
  ): string;
  function SpreadsheetControlDecodeSpreadsheetSave(
    spreadsheet: SpreadsheetControl,
    str: string,
  ...
  var SettingsControls: {
    ...
    idPrefix?: string;
    PopupChangeCallback(
      attribs: { panelobj?: any; [k: string]: any },
      id: string,
      value: any,
    ): void;
    PopupListSetValue(
      panelobj: any,
      ctrlname: string,
      value: { def: boolean; val: any } | null,
    ): void;
