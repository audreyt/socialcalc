declare namespace SocialCalc {
  ...
  namespace FormatNumber {
    ...
    function formatTextWithFormat(rawvalue: any, format_string: string): string;
    ...
    function convert_date_gregorian_to_julian(year: number, month: number, day: number): number;
